...
class LearningAgent(Agent):
    ...
    def get_state_key(self, state):
        ...
        # Construct key
        state_key = (waypoint, light, left, right, oncoming)
    ...
    def get_maxQ(self, state):
        ...
        maxQ_action = max(self.Q[state_key], key=self.Q[state_key].get)
    ...
    def createQ(self, state):
        ...
        if state_key not in self.Q.keys():
			self.Q[state_key] = {action: 0.0 for action in self.valid_actions}
    ...
    def choose_action(self, state):
        ...
        if self.learning == True:
        	...
        	# Otherwise, choose an action with the highest Q-value for the current state
        		...
        		action, maxQ = self.get_maxQ(state) # See get_maxQ() for explaination of ties
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning == True:
        	self.Q[state_key][action] = self.Q[state_key][action] + self.alpha * reward
